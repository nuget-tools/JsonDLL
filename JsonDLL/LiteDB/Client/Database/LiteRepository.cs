...
{
    /// <summary>
    /// The JsonDLL.LiteDB repository pattern. A simple way to access your documents in a single class with fluent query api
    /// </summary>
    public class LiteRepository : ILiteRepository
    {
        ...
        /// <summary>
        /// Starts JsonDLL.LiteDB database an existing Database instance
        /// </summary>
        ...
        /// <summary>
        /// Starts JsonDLL.LiteDB database using a Stream disk
        /// </summary>
