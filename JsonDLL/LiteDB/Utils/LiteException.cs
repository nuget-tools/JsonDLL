...
{
    /// <summary>
    /// The main exception for JsonDLL.LiteDB
    /// </summary>
    public class LiteException : Exception
    {
        ...
        {
            return new LiteException(INVALID_DATABASE, "File is not a valid JsonDLL.LiteDB database format or contains a invalid password.");
        }
        ...
        {
            return new LiteException(AVOID_USE_OF_PROCESS, $"JsonDLL.LiteDB do not accept System.Diagnostics.Process class in deserialize mapper");
        }
