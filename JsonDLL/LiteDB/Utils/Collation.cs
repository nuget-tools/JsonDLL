...
namespace JsonDLL.LiteDB
{
    ...
    public class Collation : IComparer<BsonValue>, IComparer<string>, IEqualityComparer<BsonValue>
    {
        ...
        public Collation(string collation)
        {
            ...
            this.LCID = JsonDLL.LiteDB.LCID.GetLCID(culture);
        ...
        public Collation(int lcid, CompareOptions sortOptions)
        {
            this.LCID = lcid;
            this.SortOptions = sortOptions;
            this.Culture = JsonDLL.LiteDB.LCID.GetCulture(lcid);

            _compareInfo = this.Culture.CompareInfo;
        }

        public static Collation Default = new Collation(JsonDLL.LiteDB.LCID.Current, CompareOptions.IgnoreCase);
