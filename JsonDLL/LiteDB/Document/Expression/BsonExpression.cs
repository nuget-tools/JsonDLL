...
namespace JsonDLL.LiteDB
{
    ...
    /// <summary>
    /// Compile and execute string expressions using BsonDocuments. Used in all document manipulation (transform, filter, indexes, updates). See https://github.com/mbdavid/JsonDLL.LiteDB/wiki/Expressions
    /// </summary>
