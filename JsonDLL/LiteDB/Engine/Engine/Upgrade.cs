...
namespace JsonDLL.LiteDB.Engine
{
    public partial class LiteEngine
    {
        ...
        /// <summary>
        /// Upgrade old version of JsonDLL.LiteDB into new JsonDLL.LiteDB file structure. Returns true if database was completed converted
        /// If database already in current version just return false
        /// </summary>
        [Obsolete("Upgrade your JsonDLL.LiteDB v4 datafiles using Upgrade=true in EngineSettings. You can use upgrade=true in connection string.")]
