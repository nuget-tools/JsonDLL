...
{
    /// <summary>
    /// Internal class to read old JsonDLL.LiteDB v4 database version (datafile v7 structure)
    /// </summary>
    internal class FileReaderV7 : IFileReader
    {
        ...
        /// <summary>
        /// Check header slots to test if data file is a JsonDLL.LiteDB FILE_VERSION = v7
        /// </summary>
